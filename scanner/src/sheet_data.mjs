...
export const RESULT_VERSION = '2.14.0';
...
function canaryRows(db, lookup) {
  ...
  return tokens.map(t => {
    ...
    return [
      ...
      safe(t.current_liquidity_usd), currentMultiple, safe(t.max_multiple_canary), '', safe(tick.volume_5m),
      ...
      safe(initial.liquidity_usd), shortJson(`ATH=${safe(t.canary_ath_price_usd)} | Risk=${risks.safety}`, 500),
